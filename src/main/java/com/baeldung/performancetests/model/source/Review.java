...
public class Review {
    ...
    public SourceUser getReviewingUser() {
        return reviewingUser;
    }

    public void setReviewingUser(SourceUser reviewingUser) {
    ...
    public Review(int shippingGrade, int pricingGrade, int serviceGrade, SourceUser reviewingUser, String note) {
